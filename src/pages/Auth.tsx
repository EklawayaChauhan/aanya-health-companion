  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 py-12">
      <div className="fixed inset-0 z-0">
        <Iridescence color={[0.3, 0.6, 0.5]} speed={0.5} amplitude={0.05} mouseReact={false} />
      </div>
      <div className="fixed inset-0 z-[1] bg-background/70 backdrop-blur-md" />
      ...
      >
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-xl font-bold">MedTalk AI</span>
        </Link>
        ...
        <div className="glass-card-strong p-6 sm:p-8">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            {mode === 'signin' ? 'Sign in to continue your wellness journey.' : 'Start chatting with Aanya today.'}
          </p>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full mb-4 gap-2 bg-white hover:bg-white/90"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" disabled={loading} className="w-full gradient-btn h-11">
